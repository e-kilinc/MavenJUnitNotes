...
public class C01_ReadExcel {
    ...
    public void readExcel() throws IOException {
        ...
        //NOT:getPhysicalNumberOfRows() methodu kullanılan yani içi dolu olan
        // satırların sayısını verir.Index 1 den başlar
        ...
        for (int i = 0; i < workbook.getSheet("Sheet1").getPhysicalNumberOfRows(); i++) {
            for (int j = 0; j <workbook.getSheet("Sheet1").getRow(i).getPhysicalNumberOfCells() ; j++) {
