...
public class C01_Iframe extends TestBase {
    ...
    Bir sayfada iframe varsa iframe içindeki webelementi handle edebilmek için
    switchTo() methoduyla iframe'e geçiş yapmamız gerekir.
    Eğer geçiş yapmazsak nosuchelementexception alırız.

    Alert'ten farkı alert çıktığında hiçbir webelementi locate edemeyiz.
    ...
    public void iframe() {
        ...
        //Ana sayfadaki ‘An iframe with a thin black border:’
        // metninde ‘black border’ yazisinin oldugunu test edelim
        ...
        driver.switchTo().frame(0); //gecis yapmazsak noSuchElementExemption atar
        ...
        //son olarak ana sayfa basliginda iframe yazisinin varligini test edelim
        driver.switchTo().defaultContent();
       // driver.navigate().refresh();//sayfayi yeniler. yukaridaki kodla ayni islevi gorur
        // driver.get(driver.getCurrentUrl());//bu sayfayi refresh yapar. yukaridaki kodla ayni gorevi gorur
