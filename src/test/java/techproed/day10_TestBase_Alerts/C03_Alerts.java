...
public class C03_Alerts extends TestBase {
    ...
    public void test01() {
        ...
        System.out.println(getTextAlert());////TestBase classinda olusturdugumuz metot.
        Assert.assertEquals("You clicked a button", getTextAlert());
        bekle(2);

        //Ve alert'ü kapatalım
        acceptAlert();//TestBase classinda olusturdugumuz metot.
    }
    ...
    public void test03() {
        ...
        Assert.assertTrue(sonucYazisi.contains("Hello"));
    }
}
