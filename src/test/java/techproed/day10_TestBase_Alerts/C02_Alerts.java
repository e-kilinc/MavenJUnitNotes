...
public class C02_Alerts extends TestBase {
    /*
           Eğer bir sayfadaki bir buttona tıkladığımızda bir uyarı penceresi çıkıyorsa
           ve bu çıkan pencereye sağ klik yapıp locate alamıyorsak, bu bir js Alert'tür.

           js Alert'ü handle edebilmek için driver'ımızı o pencere geçirmemiz gerekir. Bunun için;
        driver objemizi kullanarak
        switchTo() methoduyla alert() methodunu kullanarak js alert'e geçiş yapmış oluruz
    ...
    public void acceptAlert() {
        ...
        driver.switchTo().//gecmek icin kullanilan method
                ...
                accept(); //cikan alertte ok yada tamam butonuna tiklar
        bekle(2);
    ...
    public void dismissAlert() {
        ...
        driver.switchTo().
                alert().
                dismiss();//JS alertteki iptal ya da cancel butonuna basar

        WebElement resultMessage = driver.findElement(By.xpath("(//p)[2]"));
        String istenenMetin = "successfully";
    ...
    public void sendKeysAlert() {
        ...
        WebElement resultMessage = driver.findElement(By.xpath("(//p)[2]"));//girdigimiz metin
        String girilenMetin = "Hello";
