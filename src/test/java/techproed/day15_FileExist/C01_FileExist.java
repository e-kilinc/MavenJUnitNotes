...
public class C01_FileExist {
    ...
    public void test01(){ /*
      ...
      */
        ...
        // dosya yolunu kopyaladigimizda bu sekilde gelir. "C:\Users\seray\OneDrive\Desktop\text.txt"
        //--> "C" den once ve en sondaki çift tırnaktan önce /" olmayacak
        String dosyaYolu = "C:\\Users\\seray\\OneDrive\\Desktop\\text.txt";
        System.out.println(Files.exists(Paths.get(dosyaYolu)));//Dosya varsa true, yoksa false olarak boolean doner.
 ...
 a dinamik olması açısından

 System.getProperty("os.name") bu şekilde işletim sistemi alır
 işletim sistemin kullanıcı yolu farklı olacağından

 System.getProperty("user.home")
 gisayarımızdaki kullanıcı yolunu bu şekilde String bir değişkene farklıYol ismiyle System.getProperty("user.home")
 atayarak herseferinde farklı yolları almayla uğraşmamış oluruz.

 Dosya diyelimki masaüstünde ve her işletim
 sisteminde bize aynı yolu vereceği için bunuda ortakYol olarak bir String'e assing ederiz
     */
        ...
        String ortakYol = "\\OneDrive\\Desktop\\text.txt";
        String dosyaYolu = farkliYol+ortakYol;

        System.out.println(Files.exists(Paths.get(dosyaYolu)));//boolean olarak varsa true yoksa false doner
        Assert.assertTrue(Files.exists(Paths.get(dosyaYolu)));

        try {
            Files.delete(Paths.get(dosyaYolu));//-->Bu sekilde belirttigimiz dosyayi sileriz
        } catch (IOException e) {
    ...
    ardaki delete işlemini kullanabiliriz
         */
    ...
    Yukarıdaki methodlarda bilgisayarımızdaki dosya yolunun varlığını Files.exists()methoduyla test etmiştik
     işlemi aşağıdaki örnekteki gibi File class'ından obje oluşturarak da yapabiliriz.
         */
        String dosyaYolu = "C:\\Users\\seray\\OneDrive\\Desktop\\text.txt";
