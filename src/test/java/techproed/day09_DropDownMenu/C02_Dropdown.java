...
public class C02_Dropdown {
    ...
    public void test01() {
        ...
        select.selectByIndex(5); //index 0`dan baslar. O nedenle 2018 i secer

        Select select1 = new Select(ay);
        select1.selectByValue("6");//July --> option tagindaki value attribute degerini aldik
    ...
    public void test02() {
        ...
        for (WebElement each:eyaletlerList) {
            System.out.println("eyaletler listesi = " + each.getText());
        ...
        List<WebElement> states = driver.findElements(By.xpath("(//select)[5]"));
