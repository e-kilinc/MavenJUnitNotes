...
public class C02_BeforeClassAfterClass {
    /*
        ...
        istediğimiz kodları bu methodlara koyarız.
        Mesala testlerimiz başlamadan önce database bağlantısı yapmak için kullanılabilir
        yada hangi driver'ı kullanacaksak yine bunu BeforeClass'a koyabiliriz.
        Aynı şekilde testlerimizden sonra database'i sonlandırmak için
